...
function callback2(response2){
    ...
    var div = L.DomUtil.create('div', 'info legend'),
        ...
        labels = [
            '0-10 people per square mile', 
            '10-20 people per square mile',
            '20-50 people per square mile',
            '50-100 people per square mile',
            '100-200 people per square mile',
            '200-500 people per square mile',
            '500-1000 people per square mile',
            'Over 1000 people per square mile'
        ];
        //labels = [];
